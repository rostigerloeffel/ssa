#ifndef _SLS_FACETS_GREEDY_SD_SCORE_FACET_HPP_
#define _SLS_FACETS_GREEDY_SD_SCORE_FACET_HPP_
...
using greedy_sd_score_age_facet = greedy_sd_score_facet<State, InnerState, sls::comparators::score_age<InnerState>>;

template<typename State, typename InnerState>
using greedy_sd_score_rand_facet = greedy_sd_score_facet<State, InnerState, sls::comparators::score_rand<InnerState>>;
