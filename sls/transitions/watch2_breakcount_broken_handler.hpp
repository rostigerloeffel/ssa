#ifndef __SSA_TRANSITIONS_WATCH2_BREAKCOUNT_BROKEN_HANDLER_HPP__
#define __SSA_TRANSITIONS_WATCH2_BREAKCOUNT_BROKEN_HANDLER_HPP__
...
class watch2_breakcount_broken_minus_handler
{
public:
...
template<typename StateType>
class watch2_breakcount_broken_plus_handler
{
public:
    typedef StateType                           state_type;
    typedef typename state_type::clause_type    clause_type;
