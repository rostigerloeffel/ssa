#ifndef _SLS_TRANSITIONS_WATCH2_BREAKCOUNT_UNSAT_HANDLER_HPP_
#define _SLS_TRANSITIONS_WATCH2_BREAKCOUNT_UNSAT_HANDLER_HPP_
...
class watch2_breakcount_unsat_minus_handler
{
public:
...
template<typename StateType>
class watch2_breakcount_unsat_plus_handler
{
public:
    typedef StateType                           state_type;
    typedef typename state_type::clause_type    clause_type;
