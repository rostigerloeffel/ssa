#ifndef _SLS_TRANSITIONS_WATCH2_SAT_SCORE_UNSAT_HANDLER_HPP_
#define _SLS_TRANSITIONS_WATCH2_SAT_SCORE_UNSAT_HANDLER_HPP_
...
class watch2_sat_score_unsat_plus_handler
{
public:
