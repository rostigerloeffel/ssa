#ifndef _SLS_TRANSITIONS_WATCH2_SCORE_UNSAT_HANDLER_HPP_
#define _SLS_TRANSITIONS_WATCH2_SCORE_UNSAT_HANDLER_HPP_
...
class watch2_score_unsat_minus_handler
{
public:
...
template<typename StateType>
class watch2_score_unsat_plus_handler
{
public:
    typedef StateType                           state_type;
    typedef typename state_type::clause_type    clause_type;
